...
exports.createRazorpayOrder = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    console.log('Razorpay Order Creation - Key Details:', {
      configuredKeyId: razorpayKeyId,
      orderKeyId: razorpayOrder.id,
...
async function handlePaymentEvent(payload) {
  console.log('Webhook Payment Event Received:', JSON.stringify(payload, null, 2));
  ...
  if (statusMapping[paymentStatus]) {
    ...
    console.log('Order Status Update Attempt:', {
